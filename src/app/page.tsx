        ...
        <div className="container">
            <div className="footer-inner">
                ...
                <div className="f-links">
                    <div style={{"display":"flex","gap":"20px","fontSize":"12px","opacity":"0.8", "alignItems": "center"}}>
                        <a href="https://www.instagram.com/praticar.ensino/" target="_blank" style={{"color":"inherit","textDecoration":"none","display":"flex","alignItems":"center","gap":"5px"}} onMouseOver={(e) => e.currentTarget.style.color='#D4AF37'} onMouseOut={(e) => e.currentTarget.style.color='inherit'}>
