                        ...
                        <div className="act-wrapper dark-zone">
                            ...
                            <div className="content-block">
                                <div className="bonus-header-mini">
                                    ...
                                    <h2 className="block-title">PRESENTES EXCLUSIVOS</h2>
                                </div>
    ...
    <footer className="tactical-footer">
        <div className="container">
            <div className="footer-inner">
                ...
                <div className="f-copy" style={{"flex":"1"}}>
                    <p>© 2026 COMANDO PRATICAR. TODOS OS DIREITOS RESERVADOS.</p>
                </div>
                <div className="f-links" style={{"display":"flex","flexDirection":"column","alignItems":"flex-end","gap":"5px","flex":"1"}}>
                    ...
                    <p style={{"fontSize":"10px","opacity":"0.6","marginTop":"5px"}}>
                        Desenvolvido com amor ❤️ pela 
                        <a href="https://www.tcadigital.com.br/express" target="_blank" className="tca-link" style={{"color":"inherit","textDecoration":"none","transition":"color 0.3s ease"}}>TCA Digital Ai-Driven</a>
                    </p>
                </div>
            </div>
        </div>
